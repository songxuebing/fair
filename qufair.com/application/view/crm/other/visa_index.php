...
<div class="table_div_05"><span class="float_left"><a href="#">其他管理</a>&nbsp;&gt;&nbsp;<a href="#">区域管理</a></span><span class="float_right">
	...
	&nbsp;&nbsp;
	<a href="/other/region/option/visa_edit/" class="AjaxWindow btn_05" href-id="0" data-title="添加区域">添加签证区域</a>
        ...
        <div class="J-alllist">
            ...
            <div class="list_info">
                <ul class="row">
                    ...
                    <li class="li_10"><a href="/other/region/option/visa_edit/id/<?php echo $v['id'];?>" class="AjaxWindow btn_05" href-id="<?php echo $v['id'];?>" data-title="修改区域">编辑</a><a href="#" class="RemoveLink_visa btn_05" data-id="<?php echo $v['id'];?>" data-url="/other/region/">删除</a></li>
                </ul>
            </div>
            <?php
