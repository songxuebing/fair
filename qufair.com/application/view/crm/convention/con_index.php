...
<body class="font_14px">
	...
	<form action="/convention/conindex/" method="post" name="search" autocomplete="off">
	  发布者手机/展会标题：<input type="text" name="key" id="key" class="btn_05"  style="width:150px; text-align:left;"  placeholder="输入发布者手机号/展会标题" value="<?php echo $this->param['key'];?>" />&nbsp;&nbsp;
	  发布时间：
	...
	<div class="table_div_02 J-table_div_02">
	  ...
	  <div class="list_info">
		<ul class="row">
		  ...
		  <?php }?>
          <a href="/public/Autologin/type/convention/member_id/<?php echo $v['member_id'];?>/id/<?php echo $v['detail_id'];?>" target="_blank" class="btn_05">编辑</a>
