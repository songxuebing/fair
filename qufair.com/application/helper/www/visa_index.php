...
//        if ($val['visa_state'] == $delta['0']) {
//           $da['0'][$key] = $data[$key];
//        }
//        if ($val['visa_state'] == $delta['1']) {
//            $da['1'][$key] = $data[$key];
//        }
//        if ($val['visa_state'] == $delta['2']) {
//            $da['2'][$key] = $data[$key];
//        }
//        if ($val['visa_state'] == $delta['3']) {
//            $da['3'][$key] = $data[$key];
//        }
//        if ($val['visa_state'] == $delta['4']) {
//            $da['4'][$key] = $data[$key];
//        }
//        if ($val['visa_state'] == $delta['5']) {
//            $da['5'][$key] = $data[$key];
//        }
        }
    }
    //var_dump($da);exit();
    $this->Assign('data', $da);
    echo $this->GetView('visa_new.php');
} else {
