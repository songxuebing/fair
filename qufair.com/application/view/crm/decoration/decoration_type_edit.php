...
<form action="/decoration/type/" method="post" name="brand" class="AjaxForm brand" autocomplete="off" enctype="multipart/form-data">
<table width="600" border="0" cellspacing="0" cellpadding="0" class="table_list">
  <tr>
    <td height="45" align="right">分类名称：</td>
    <td align="left"><input name="visa_name" type="text" id="visa_name" value="<?php echo(empty($this->data['visa_name']) ? '' : $this->data['visa_name']);?>" class="input_01"></td>
  </tr>
  <tr>
    ...
    <td align="left"><select name="parent_id" id="parent_id">
		...
		<?php
			foreach($this->category as $key=>$value){
				$select=$value['visa_id']==$this->data['parent_id'] ? ' selected' : '';
