    ...
    <div class="mm_fbtz fr">
        <form action="/forum/index/" method="post" name="rote" enctype="multipart/form-data" class="AjaxForm rote" autocomplete="off">
            ...
            <div class="mm_fbtz_bianji">
                <textarea name="content" style="width:780px; height:350px;display:none"><?php echo $this->data['content'];?>
                </textarea>

                <li _t_nav="home" class="nav-up-selected-inpage">
                    <h2>
                        <a href="/prototype.html" target="_blank">投稿模板</a>
                    </h2>
                </li>
                <input type="hidden" name="ajax" value="1">
                <input type="hidden" name="id" value="<?php echo $this->id;?>">
                <input type="hidden" name="option" value="submit_contribute">
