...
<table width="600" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <!--
  <tr>
    <td height="45" align="right">账号金额：</td>
    <td align="left"><input name="money" type="text" id="money" value="<?php echo(empty($this->data['money']) ? '' : $this->data['money']);?>" class="input_01"></td>
  </tr>
