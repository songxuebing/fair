<?php
        $webtitle = "提供便捷国外展览会展品物流服务，解决展商海运，空运等物流问题".' - 去展网';
        $webdescription = "解决展览会展品运输问题，服务范围涉及欧洲，中东，北美，南美，亚洲等地区运输，满足参展商展品空运 海运 陆运运输需求，帮助展商解决国内外展会物流问题";
?>
...
<div class="mm_zhanhui_list mm_mid">
    <div class="mm_tezhuang_seach">
		<form action="/logistics/index/" method="post" name="search">
...
<script type="text/javascript">
	jQuery(document).ready(function(e) {
		...
		jQuery(".J-attr").on('click','a',function(){
			...
			window.location.href= '/logistics/index/country/'+country+'/city/'+city+'/year/'+year+'/month/'+month+'';
...
<!--                            <a href="/logistics/index/option/detail/id/--><?php //echo $v['log_id'];?><!--" style="color:#333;">-->
                        ...
                        <p>物流方式：
                        	<?php echo $v['log_freight']['ky']['ky_txt'].'&nbsp;'.$v['log_freight']['hy']['hy_txt'].'&nbsp;'.$v['log_freight']['ly']['ly_txt'];?>
                        </p>
    ...
    <div class="mm_zhanhui_right fr">
		...
		<script type="text/javascript">
			jQuery.get('/public/index/option/trading',{'output':'json','type':'logistics'},function(data){
