...
<div class="table_div_05"><span class="float_left"><a href="#">其他管理</a>&nbsp;&gt;&nbsp;<a href="#">区域管理</a></span><span class="float_right">
	<select name="delta" onChange="window.location.href='/other/region/option/visa/delta/'+encodeURI(this.value)+''">
	...
	&nbsp;&nbsp;
	<a href="/other/region/option/route_edit/" class="AjaxWindow btn_05" href-id="0" data-title="添加区域">添加行程 区域</a>
...
<div class="table_div_01">
    <ul>
        <li class="li_5">ID</li>
        <li class="li_40">区域名称</li>
        <li class="li_20">英文名称</li>
        <li class="li_15">子区域</li>
        ...
        <div class="J-alllist">
            ...
            <div class="list_info">
                <ul class="row">
                    ...
                    <li class="li_40"><?php echo $v['name'];?></li>
                    <li class="li_20"><?php echo $v['name_en'];?></li>
                    <li class="li_15">
                        <a href="javascript:;" class="J-nextclick on"><?php echo count($v['next']);?></a>
                    </li>
                    <li class="li_10"><a href="/other/region/option/route_edit/id/<?php echo $v['id'];?>" class="AjaxWindow btn_05" href-id="<?php echo $v['id'];?>" data-title="修改区域">编辑</a><a href="#" class="RemoveLink_route btn_05" data-id="<?php echo $v['id'];?>" data-url="/other/region/">删除</a></li>
                </ul>
            </div>
            <?php
            if(!empty($v['next'])) foreach($v['next'] as $key=>$val){
                ...
                <div class="list_info J-next fn-hiden">
                    <ul class="row">
                        ...
                        <li class="li_25"></li>
                        <li class="li_15"><a href="/other/region/option/edit/id/<?php echo $val['id'];?>" class="AjaxWindow btn_05" href-id="<?php echo $val['id'];?>" data-title="修改区域">编辑</a><a href="#" class="RemoveLink_visa btn_05" data-id="<?php echo $val['id'];?>" data-url="/other/region/">删除</a></li>
                    </ul>
                </div>
            <?php
            }
