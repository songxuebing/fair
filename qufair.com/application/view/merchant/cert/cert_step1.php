        ...
        <div class="ms_rz_ziliao">
            <ul>
                <li>
                    <div class="clearfix">
                        <label>企业全称</label>
                        <input name="company_name" type="text" maxlength="50" placeholder="" value="<?php echo $this->data['company_name'];?>">
                    </div> 
                ...
                <li>
                    <div class="clearfix">
                        <label>企业法人代表</label>
                        <input type="text" name="company_owner" maxlength="10" placeholder="" value="<?php echo $this->data['company_owner'];?>">
                    </div> 
                </li>
                <!--
                <li>
                    <div class="clearfix">
                        <label>法人身份证号</label>
                        <input type="text" placeholder="" maxlength="18" name="owner_cardno" value="<?php echo $this->data['owner_cardno'];?>">
                    </div> 
                </li>
                <li>
                    <div class="clearfix">
                        <label>法人手机号码</label>
                        <input type="text" placeholder="" maxlength="11" name="owner_mobile" value="<?php echo $this->data['owner_mobile'];?>">
                    </div> 
                </li>
                <li>
                    <div class="clearfix">
                        <label>企业服务</label>
                        <input type="text" placeholder="可提供的服务内容" maxlength="50" name="company_service" value="<?php echo $this->data['company_service'];?>">
                    </div> 
                </li>
                -->
                <li>
                    <div class="clearfix">
                        <label>企业座机</label>
                        <input type="text" placeholder="" maxlength="20" name="company_tel" value="<?php echo $this->data['company_tel'];?>">
                    </div> 
                ...
                <li>
                    <div class="clearfix">
                        <label>营业执照号</label>
                        <input type="text" placeholder="" maxlength="30" name="company_lice" value="<?php echo $this->data['company_license'];?>">
                    </div> 
                    <p>请填写工商营业执照上的注册号</p>
                </li>
                <li>
                    <div class="clearfix">
                        <label>组织机构代码</label>
                        <input type="text" placeholder="" maxlength="30" name="company_orgcode" value="<?php echo $this->data['company_orgcode'];?>">
                    </div> 
                    <p>请填写组织机构代码证上的代码</p>
                </li>
                <li>
                    <div class="clearfix">
                        <label>税务登记证号</label>
                        <input type="text" placeholder="" maxlength="30" name="company_regcert" value="<?php echo $this->data['company_regcert'];?>">
                    </div> 
                </li>
                <li>
                    <div class="clearfix">
                        <label>企业详细地址</label>
                        <input type="text" placeholder="" maxlength="50" name="company_address" value="<?php echo $this->data['company_address'];?>">
                    </div> 
                </li>
            </ul>
        </div>
		...
		<div class="ms_rz_ziliao">
			<ul>
                <li>
                    <div class="clearfix">
                        <label>企业开户名称</label>
                        <input type="text" placeholder="" maxlength="30" name="bank_comname" <?php echo empty($this->data['bank_comname']) ? '' : 'readonly' ;?> value="<?php echo $this->data['bank_comname'];?>">
                    </div> 
                ...
                <li>
                    <div class="clearfix">
                        <label>企业银行账号</label>
                        <input type="text" placeholder="" maxlength="30" name="bank_account" <?php echo empty($this->data['bank_account']) ? '' : 'readonly' ;?> value="<?php echo $this->data['bank_account'];?>">
                    </div>
				...
				<li>
                    <div class="clearfix">
                        <label>企业开户银行</label>
                        <input type="text" placeholder="" maxlength="50" name="bank_name" <?php echo empty($this->data['bank_name']) ? '' : 'readonly' ;?> value="<?php echo $this->data['bank_name'];?>">
                    </div> 
                </li>
				<li>
                    <div class="clearfix">
                        <label>开户银行地址</label>
                        <input type="text" placeholder="" maxlength="50" name="bank_branch" <?php echo empty($this->data['bank_branch']) ? '' : 'readonly' ;?> value="<?php echo $this->data['bank_branch'];?>">
                    </div> 
                </li>
			</ul>
		</div>
        ...
        <div class="ms_rz_ziliao">
            <ul>
                <li>
                    <div class="clearfix">
                        <label>运营者姓名</label>
                        <input type="text" placeholder="" maxlength="10" name="operate_name" value="<?php echo $this->data['operate_name'];?>">
                    </div> 
                ...
                <li>
                    <div class="clearfix">
                        <label>运营者部门职位</label>
                        <input type="text" placeholder="" maxlength="20" name="operate_position" value="<?php echo $this->data['operate_position'];?>">
                    </div> 
                </li>
                <li>
                    <div class="clearfix">
                        <label>运营者手机号码</label>
                        <input type="text" placeholder="" maxlength="11" name="operate_mobile" value="<?php echo $this->data['operate_mobile'];?>">
                    </div> 
                ...
                <li>
                    <div class="clearfix">
                        <label>运营者短信验证</label>
                        <input type="text" placeholder="" style="width:380px;" maxlength="6" name="operate_code">
                ...
                <li>
                    <div class="clearfix">
                        <label>运营者电话</label>
                        <input type="text" placeholder="" maxlength="20" name="operate_tel" value="<?php echo $this->data['operate_tel'];?>">
                    </div> 
                    <p>包括区号、电话、分机号，以“-”隔开</p>
                </li>
                <li>
                    <div class="clearfix">
                        <label>运营者电子邮箱</label>
                        <input type="text" placeholder="" maxlength="30" name="operate_email" value="<?php echo $this->data['operate_email'];?>">
                    </div> 
                    <p>&nbsp;</p>
                </li>
                <li>
                    <div class="clearfix">
                        <label>运营者身份证号</label>
                        <input type="text" placeholder="" maxlength="18" name="operate_cardno" value="<?php echo $this->data['operate_cardno'];?>">
                    </div> 
                    <p>请填写工商营业执照上的注册号</p>
                </li>
                -->
            ...
            <dl class="clearfix">
                <dt>法人授权书</dt>
                <dd>
                    <p>请下载<a href="<?php echo STYLE_URL;?>/style/quzhan/doc/sqwts.doc" target="_blank">授权文件</a></p>
                    <p>提交中华人民共和国居民身份证，无居民身份证的内地居民可提交《临时居民身份
                    证》。格式要求：支持.jpg .jpeg .bmp .gif .png格式照片，大小不超过5M。</p>
                    <div class="ms_sfz fl">
