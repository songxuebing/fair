...
<div class="mm_dingdan_detail mm_mid">
    ...
    <div class="ms_seach clearfix">
		...
		<form action="/visa/order/" method="post" name="search">
    ...
    <div>
        ...
        <div class="mm_zh_dingdan_con">
            <ul class="clearfix">
                <li>
                    <dl>
                        <dt><img src="<?php echo Common::AttachUrl($v['visa_cover']);?>!a200" width="90" height="90"></dt>
                        <dd>
                            <h6><?php echo $v['visa_name'];?></h6>
                            <p>签证领区：<?php echo $v['visa_area'];?></p>
                            <p>签证类型：<?php echo $v['visa_type'];?></p>
                        </dd>
                    </dl>
                </li>
            ...
            <div class="mm_zh_dingdancon">
                ...
                <div>
					...
					<?php }?>
                    <a href="/visa/order/option/detail/id/<?php echo $v['id'];?>" class="mm_zh_dingdan_detail" target="_blank">订单详情</a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	jQuery("#mm_xiajia").on('click','.J-queding',function(){
		...
		jQuery.post('/visa/order/option/changeprice/',{'id':id,'money':money},function(data){
			if(data.success){
