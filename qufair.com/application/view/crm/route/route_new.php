...
<div class="table_div_01">
    <ul>
        ...
        <li class="li_5">编号</li>
        <li class="li_30">行程名称</li>
        <li class="li_10">目的地</li>
        <li class="li_10">出发地</li>
    ...
    <?php if(!empty($this->data['All'])) foreach($this->data['All'] as $k=>$v){?>
        ...
        <div class="list_info">
            <ul class="row">
                ...
                <li class="li_30"><?php echo $v['title'];?></li>
                <li class="li_10"><?php echo $v['regional'].'-'.$v['countries'].'-'.$v['city'];?></li>
                <li class="li_10"><?php echo $v['departure'];?></li>
                ...
                <li class="li_15">
                    ...
                    <a data-title="修改" href-id="<?php echo $v['id'];?>" class="PrintWindow btn_05" href="/route/index/option/route_new_edit/id/<?php echo $v['id'];?>">编辑</a>
