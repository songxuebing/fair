...
<div class="mm_denglu" style="background:url(<?php echo STYLE_URL;?>/style/quzhan/images/20160202/mm_img01_02.jpg) no-repeat; background-position: 50% 50%;">
    <div class="mm_mid">
        <div class="mm_denglu_con fr">
            <div class="mm_form">
                <div class="reg-box">
                	<a href="<?php echo WEB_URL;?>/login/index/"  style="position:relative; top:6px;">参展商登陆</a>
                    <a style="font-size:16px; padding-top:5px;" class="on" href="<?php echo MERCHANT_URL;?>/auth/login/">展会服务商登陆</a>
                </div>
                <form action="/auth/login/" class="AjaxForm" method="post" autocomplete="off">
                <ul>
                    <li>
...
function sucessCallback(){
	...
	window.location.href = '/cert/index/';
}
