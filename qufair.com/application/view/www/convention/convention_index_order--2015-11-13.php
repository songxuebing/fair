                ...
                <div class="yListr">
                    ...
                    <ul class="clearfix J-booth">
                        ...
                        <li class="J-attr" style="float:none; overflow:hidden;">
							...
							?>
                            <em class="<?php echo $vv['is_rent'] == 1 ? 'em_drop' : '' ;?>" data-detailid="<?php echo $vv['detail_id'];?>" data-id="<?php echo $vv['area_id'];?>" data-booth-type="<?php echo $vv['booth_type'];?>" data-opening="<?php echo $vv['opening'];?>" data-group-price="<?php echo $vv['group_price'];?>" data-booth-price="<?php echo $vv['booth_price'];?>"><?php echo $vv['booth_no'];?></em>
                            <?php
								}
							?>
                        </li>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{},"image":{"viewList":["tsina","weixin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["tsina","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            ...
            <div class="fr">
                <div class="mm_zhfw_jiage">价格：<em class="J-total-price">￥0</em></div>
