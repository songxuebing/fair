...
<body class="font_14px">
	...
	<div class="table_div_05"><span class="float_left"><a href="#">物流管理</a>&nbsp;&gt;&nbsp;<a href="#">物流类型</a></span><span class="float_right">
	  <input type="button" class="btn_05 AjaxWindow"  value="添加物流类型" href="/logistics/type/option/edit/id/0" href-id="0" data-title="添加物流类型" />
	  </span></div>
	<div class="clear_15px"></div>
    ...
    <form action="/logistics/type/" method="post" name="all" class="AjaxForm">
	<!--列表-->
	<div class="table_div_02 J-table_div_02">
	  ...
	  <div class="list_info">
		<ul class="row">
		  ...
		  <li class="li_10"><a href="/logistics/type/option/edit/id/<?php echo $v['visa_id'];?>" class="AjaxWindow btn_05" href-id="<?php echo $v['visa_id'];?>" data-title="修改签证信息">编辑</a><a href="#" class="RemoveLink btn_05" data-id="<?php echo $v['visa_id'];?>" data-url="/logistics/type/">删除</a></li>
		</ul>
	  </div>
	  <!--/条-->
	  <?php }?>
