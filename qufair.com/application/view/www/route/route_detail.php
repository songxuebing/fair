...
<div class="mm_mid">
    ...
    <div class="mm_zh_detail clearfix">
            ...
            <div class="examples_body">
                <div class="examples_bg">
                    <div class="examples_image J-examples_image">
                        <img src="<?php echo Common::AttachUrl($this->data['cover']);?>" alt="" style="background:url(<?php echo STYLE_URL;?>/style/quzhan/images/loading.gif) no-repeat 50% 50%;" />
                      
                    </div>
                    <div class="mune_thumb J-mune_thumb">
                        <ul>
                            <li class="active">
                                <a data-href="<?php echo Common::AttachUrl($this->data['cover']);?>" href="javascript:;"><img src="<?php echo Common::AttachUrl($this->data['cover']);?>!a200" alt="Image Name" style="background:url(<?php echo STYLE_URL;?>/style/quzhan/images/loading.gif) no-repeat 50% 50%;" /></a>
                            </li>
                            <?php
        ...
        <div class="mm_zh_detail_right fr">
            ...
            <ul class="mm_xingcheng">
                <li>
				<?php for($i=1;$i<=$this->data['average'];$i++){?>
				<img src="<?php echo STYLE_URL;?>/style/quzhan/images/mm_star01.png">
				<?php }?>
				<i><?php echo StringCode::numberToChar($this->data['average']);?>星</i></li>
                <li>出发时间：<em><?php echo date('Y-m-d',$this->data['leave_time']);?> 至 <?php echo date('Y-m-d',$this->data['end_time']);?></em></li>
                <li>赶往展馆：<?php echo $this->data['pavilion'];?></li>
                <li>
                    出发地点：<?php echo $this->data['leave_area'];?>
                   
                </li>
                <li>服务城市：<?php echo $this->data['route_city'];?></li>
                <li class="mm_xingcheng_jiage">￥<?php echo $this->data['price'];?><span>/人</span></li>
            </ul>
            <div class="clearfix">
                <div class="mm_xingcheng_bus">
                    <a href="/route/order/id/<?php echo $this->data['id'];?>">立即购买</a>
                </div>
...
<div class="mm_mid clearfix">
    ...
    <div class="mm_zhanhui_left fl">
    	<div style="margin-bottom:20px;"><img src="<?php echo STYLE_URL;?>/style/quzhan/images/route.png" /></div>
        <!-- 展位供应商 -->
        ...
        <div class="mm_zhanhui_con1 clearfix">
            ...
            <div class="mm_zhanhui_pingfen">
                ...
                <input type="hidden" name="is_type" value="3">
    ...
    <div class="mm_zhanhui_right fr">
		...
		<script type="text/javascript">
			jQuery.get('/public/index/option/data',{'output':'json','type':'route','key':''},function(data){
				var bt=baidu.template;
				var html=bt('new-xingcheng',data);
				document.getElementById('J-new-xingcheng').innerHTML=html;
			
			},'json');
			jQuery.get('/public/index/option/data',{'output':'json','type':'visa','key':''},function(data){
				var bt=baidu.template;
				var html=bt('new-qz',data);
				document.getElementById('J-new-qz').innerHTML=html;
			
			},'json');
			jQuery.get('/public/index/option/data',{'output':'json','type':'logistics','key':''},function(data){
				var bt=baidu.template;
				var html=bt('new-wl',data);
				document.getElementById('J-new-wl').innerHTML=html;
			
			},'json');
			jQuery.get('/public/index/option/data',{'output':'json','type':'decoration','key':''},function(data){
				var bt=baidu.template;
