...
<form action="/adv/index/" method="post" name="pos" class="AjaxForm pos" autocomplete="off" enctype="multipart/form-data">
<table width="600" border="0" cellspacing="0" cellpadding="0" class="table_list">
  ...
  <tr>
    <td height="45" align="right">所属广告位：</td>
    <td style=" padding-top:5px; padding-bottom:5px;">
	<select name="pos_id" id="pos_id">
	<?php
		if(!empty($this->pos)) foreach($this->pos as $k=>$v){
			$select = $v['id'] == $this->data['pos_id'] ? ' selected="selected"' : '';
