...
<body class="font_14px">
	...
	<div class="table_div_05"><span class="float_left"><a href="#">签证管理</a>&nbsp;&gt;&nbsp;<a href="#">签证产品类型</a></span><span class="float_right">
	  <input type="button" class="btn_05 AjaxWindow"  value="添加产品类型" href="/visa/protype/option/edit/id/0" href-id="0" data-title="添加产品类型" />
	  </span></div>
	<div class="clear_15px"></div>
    ...
    <form action="/visa/protype/" method="post" name="all" class="AjaxForm">
	<!--列表-->
	<div class="table_div_02 J-table_div_02">
	  ...
	  <div class="list_info">
		<ul class="row">
		  <li class="li_5"><?php echo $v['pro_id'];?></li>
          <li class="li_50"><?php echo $v['type_name'];?></li>
          <li class="li_15"><?php echo $v['sort_order'];?></li>
          <li class="li_15"><?php echo $v['is_open']==1 ? '√' : '×';?></li>
          
		  <li class="li_10"><a href="/visa/protype/option/edit/id/<?php echo $v['pro_id'];?>" class="AjaxWindow btn_05" href-id="<?php echo $v['pro_id'];?>" data-title="修改产品信息">编辑</a><a href="#" class="RemoveLink btn_05" data-id="<?php echo $v['pro_id'];?>" data-url="/visa/protype/">删除</a></li>
		</ul>
	  </div>
	  <!--/条-->
	  <?php }?>
