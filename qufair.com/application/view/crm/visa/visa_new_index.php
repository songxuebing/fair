...
<div class="table_div_05"><span class="float_left"><a href="#">签证管理</a>&nbsp;&gt;&nbsp;<a href="#">签证列表</a></span><span class="float_right"></span>
    <span class="float_right"><a data-title="添加文章" href-id="0" class="PrintWindow btn_05" href="/visa/index/option/new_edit/">添加签证</a></span>
</div>
<div class="clear_15px"></div>
<div class="table_div_04" style="padding-left:5px;">
    <form action="/visa/index/option/new_visa" method="post" name="search" autocomplete="off">
...
<div class="table_div_01">
    <ul>
        ...
        <li class="li_5">编号</li>
        <li class="li_10">名称</li>
        <li class="li_10">国家</li>
        <li class="li_10">签证类型</li>
        <li class="li_10">有效期</li>
        <li class="li_10">办理时长</li>
        <li class="li_10">办理地点</li>
        <li class="li_10">价格</li>
    ...
    <?php if(!empty($this->data['All'])) foreach($this->data['All'] as $k=>$v){?>
        ...
        <div class="list_info">
            <ul class="row">
                ...
                <li class="li_10"><?php echo $v['visa_title'];?></li>
                <li class="li_10"><?php echo $v['visa_countries'];?></li>
                <li class="li_10"><?php echo $v['visa_type'];?></li>
                <li class="li_10"><?php echo $v['visa_lasts'];?></li>
                <li class="li_10"><?php echo $v['visa_handle'];?></li>
                <li class="li_10"><?php echo $v['visa_place'];?></li>
                <li class="li_10"><?php echo $v['visa_price'];?></li>
                <li class="li_15">
                    <a href="/visa/index/option/new_edit/id/<?php echo $v['visa_id'];?>" target="" class="PrintWindow btn_05">编辑</a>
                </li>
            </ul>
        </div>
        <!--/条-->
