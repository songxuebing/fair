            ...
            <div class="navigation-v3">
                <ul>
                    ...
                    <li class="" _t_nav="product">
                        <h2>
                            <a href="/convention" style="<?php echo $this->Controller == 'convention' ? 'color:#ff4a00' : '';?>">国际展会</a>
                        </h2>
                    </li>
                    <li class="" _t_nav="wechat">
                        <h2>
                            <a href="/route" style="<?php echo $this->Controller == 'route' ? 'color:#ff4a00' : '';?>">商务旅游</a>
                        </h2>
                    </li>
                    <li class="" _t_nav="solution">
                        <h2>
                            <a href="/visa" style="<?php echo $this->Controller == 'visa' ? 'color:#ff4a00' : '';?>">国际签证</a>
                        </h2>
                    </li>
                    <li class="" _t_nav="cooperate">
                        <h2>
                            <a href="/logistics" style="<?php echo $this->Controller == 'logistics' ? 'color:#ff4a00' : '';?>">国际物流</a>
                        </h2>
                    </li>
                    <li class="" _t_nav="support">
                        <h2>
                            <a href="/decoration" style="<?php echo $this->Controller == 'decoration' ? 'color:#ff4a00' : '';?>">展览展示</a>
                        </h2>
                    </li>
                    <li>
                        <h2>
                            <a href="/news" style="<?php echo $this->Controller == 'forum' ? 'color:#ff4a00' : '';?>">会展资讯</a>
                        </h2>
                    </li>
                </ul>
            </div>
            ...
            <div class="mm_nav_xiala">
                <div>
					...
					<dl>
						...
						?>
						<dd><a href="/convention/index/industry/<?php echo $val['name'];?>"><?php echo $val['name'];?></a></dd>
						<?php
							}
						?>
					</dl>
                    ...
                    <div class="tab-pal">
                        <ul>
							<?php
								if(!empty($v['next'])) foreach($v['next'] as $key=>$val){
							?>
                            <li><a href="/route/index/country/<?php echo $val['name'];?>"><?php echo $val['name'];?></a></li>
							<?php
								}
							?>
                        </ul>
                    ...
                    <div class="tab-pal">
                        <ul>
							<?php
								if(!empty($v['next'])) foreach($v['next'] as $key=>$val){
							?>
                            <li><a href="/visa/index/country/<?php echo $val['name'];?>"><?php echo $val['name'];?></a></li>
							<?php
								}
							?>
                        </ul>
                    ...
                    <div class="tab-pal">
                        <ul>
							<?php
								if(!empty($v['next'])) foreach($v['next'] as $key=>$val){
							?>
                            <li><a href="/decoration/index/country/<?php echo $val['name'];?>"><?php echo $val['name'];?></a></li>
							<?php
								}
							?>
                        </ul>
                    ...
                    <div class="tab-pal">
                        <ul>
							<?php
								if(!empty($v['next'])) foreach($v['next'] as $key=>$val){
							?>
                            <li><a href="/logistics/index/country/<?php echo $val['name'];?>"><?php echo $val['name'];?></a></li>
							<?php
								}
							?>
                        </ul>
