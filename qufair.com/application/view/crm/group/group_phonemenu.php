...
<div class="table_div_05"><span class="float_left"><a href="#">用户组管理</a>&nbsp;&gt;&nbsp;<a href="#">手机菜单编辑</a></span><span class="float_right">
  </span></div>
<div class="clear_15px"></div>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
    <tr>
      ...
      <td align="left" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="35">底部菜单最多显示三个，选中的才能保存，多选请按住ctrl</td>
          </tr>
          <tr>
            <td height="234">
...
<input type="hidden" name="option" value="phonemenu_submit">
