...
<form action="/visa/protype/" method="post" name="brand" class="AjaxForm brand" autocomplete="off" enctype="multipart/form-data">
<table width="600" border="0" cellspacing="0" cellpadding="0" class="table_list">
  <tr>
    <td height="45" align="right">分类名称：</td>
    <td align="left"><input name="type_name" type="text" id="type_name" value="<?php echo(empty($this->data['type_name']) ? '' : $this->data['type_name']);?>" class="input_01"></td>
  </tr>
  <tr>
    ...
    <td align="left"><select name="parent_id" id="parent_id">
		...
		<?php
			foreach($this->category as $key=>$value){
				$select=$value['pro_id']==$this->data['parent_id'] ? ' selected' : '';
