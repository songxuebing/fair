        ...
        <div class="mm_geren_right fr">
            ...
            <div class="mm_geren_dingdan">
                ...
                <dl class="clearfix">
                    ...
                    <dd>
                        <h3><a href="/user/order/option/detail/sn/<?php echo $v['order_sn'];?>" style="color:#333;" target="_blank"><?php echo $v['decoration_order']['de_title'];?> <span style="color:#428bca;">(订单详情)</span></a><a target="blank" href="tencent://message/?uin=<?php echo $v['decoration_order']['de_style']['qq']?>&Site=http://www.qufair.com&Menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=1:<?php echo $v['decoration_order']['de_style']['qq']?>:8" alt="点击这里给我发消息"></a></h3>
                        <ul>
