...
<div class="mm_dingdan_detail mm_mid">
    ...
    <div class="ms_seach clearfix">
		...
		<form action="/logistics/order/" method="post" name="search">
    ...
    <div>
        ...
        <div class="mm_zh_dingdan_con">
            <ul class="clearfix">
                <li>
                    <dl>
                        <dt><img src="<?php echo Common::AttachUrl($v['log_detail']['log_cover']);?>!a200" width="90" height="90"></dt>
                        <dd>
                            <h6><?php echo $v['log_detail']['log_title'];?></h6>
                            <p>物流集散地：<?php echo $v['log_detail']['log_location'];?></p>
                            <p>物流方式：<?php echo $v['mode'];?></p>
                        </dd>
                    </dl>
                </li>
                <li><div><?php echo $v['num'];?></div></li>
            ...
            <div class="mm_zh_dingdancon">
                ...
                <div>
					...
					<?php }?>
                    <a href="/logistics/order/option/detail/id/<?php echo $v['id'];?>" class="mm_zh_dingdan_detail" target="_blank">订单详情</a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	jQuery("#mm_xiajia").on('click','.J-queding',function(){
		...
		jQuery.post('/logistics/order/option/changeprice/',{'id':id,'money':money},function(data){
			if(data.success){
